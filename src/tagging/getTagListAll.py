...
file_list=["/user/cringwal/home/all_dataset301023.csv","/user/cringwal/home/all_surveys301023.csv","/user/cringwal/home/all_models301023.csv"]
tags_list=[]
...
for k in tag_dict.keys():
    if(str(k)!="None" and str(k)!= "nan" and "SAT_" in k.upper() ):
        ...
        if(val not in tag_list_level1.keys()):
...
dict1=[{"tag":k, "level1":tag_list_level0[k]["level1"],"nb":tag_list_level0[k]["nb"]} for k in tag_list_level0.keys()]
...
columns = ['tag', 'nb']
dict2=[{"tag":k, "nb":tag_list_level1[k]} for k in tag_list_level1.keys()]
