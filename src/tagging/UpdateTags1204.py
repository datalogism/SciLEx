...
while(continue_==True):
    print('HEY >',start)
    r_items = requests.get(url+"/items/top?limit=100&start="+str(start), headers=headers)
...
to_keep_list=['SAT_DOMAIN', 'SAT_GRANULARITY', 'SAT_LANG', 'SAT_MODEL', 'SAT_TASK', 'SAT_ARCHI', 'SAT_BASELINE', 'SAT_DATASET', 'SAT_LEARNING', 'SAT_FEATURES', 'SAT_NEGATIVEEXAMPLES', 'SAT_DECODING', 'SAT_LOSS', 'SAT_COST_EVAL', 'SAT_OUTPUT']
to_add_list= ['1_SPECIFIC_REL_TYPE', 'N_OBJECT_PROP', 'N_DATATYPE_PROP', 'PROMPT_TYPE']
to_delete_list=  ['SAT_METHOD_GENERATION','SAT_METHOD_SELECTION','SAT_DATATYPES_PROP', 'SAT_NBENTITY', 'SAT_NBEVALEX', 'SAT_REL_TYPE', 'SAT_NBEXPOSITIVE', 'SAT_NBIMAGES', 'SAT_NBNEGATIVEEXAMPLES', 'SAT_NBPARAGRAPH', 'SAT_NBSENT', 'SAT_NBTABLES', 'SAT_NBTESTEX', 'SAT_NBTRAINEX', 'SAT_NBTRIPLES', 'SAT_NBTYPES_ENTITY', 'SAT_NBTYPES_RELATIONS', 'SAT_CONTEXT', 'SAT_NBDOC', 'SAT_5STARS', 'SAT_FOCUS', 'SAT_EXTEND', 'FOCUS_STUDY', 'FOCUS_STUDY_FINAL', 'EXAMPLE', 'SAT_CROSSVALIDATION', 'SAT_METRIC', 'SAT_NBDATASET', 'SAT_NBMODEL_COMPARED', 'FOCUS_EXAMPLE', 'SAT_OLDTAG', 'SAT', 'SAT_MODEL_COMPARE', 'SAT_OPTI', 'SAT_OPTI_DROPOUT', 'SAT_OPTI_LR', 'SAT_RQ', 'SAT_SPLIT_DATA_EVAL', 'SAT_SPLIT_DATA_TEST', 'SAT_SPLIT_DATA_TRAIN', 'SAT_CLARITY', 'FOCUS_STUDY_OCT', 'SAT_MULTICOMPONENTS', 'SAT_OPTI_SCH', 'SAT_OPTI_STEPS', 'SAT_OPTI_WEIGHT_DECAY', 'SAT_NBEVALEX_INST', 'SAT_NBEVALEX_TRIPLE', 'SAT_NBTESTEX_INST', 'SAT_NBTESTEX_TRIPLE', 'SAT_NBTRAINEX_INST', 'SAT_NBTRAINEX_TRIPLE', 'SAT_OPTI_EPOCH', 'SAT_OPTI_WARMUP', 'SAT__FEATURE', 'SAT_EXTENDABLE', 'CONTEXTUALIZED REPRESENTATION', 'KNOWLEDGE GRAPH COMPLETION', 'KNOWLEDGE GRAPH EMBEDDING', 'LINK PREDICTION', 'STRUCTURED KNOWLEDGE' 'SAT_ALL_CHECKED']
