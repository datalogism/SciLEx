...
to_keep_list=['SAT_ARCHI', 'SAT_LANG', 'SAT_DOMAIN', 'SAT_FOCUS_PERIOD', 'SAT_GRANULARITY', 'SAT_MODEL', 'SAT_TASK', 'SAT_DATASET', 'SAT_LEARNING']
to_add_list=  ['SAT_PTM', 'BIBLIO_METHODO' 'BENCHMARK']
to_delete_list=  ['SAT_BENCHMARK_TYPE', 'SAT_CONTEXT', 'SAT_DEFINED_PROTOCOL', 'SAT_FOCUS', 'SAT_INTEREST', 'SAT_NBDATASET', 'SAT_NBMODEL', 'SAT_REL_TYPE', 'SAT_TYPE', 'SAT_TYPOLOGY_DIM', 'CHECKED1023', 'SAT_TAXONOMY', 'SAT_RQ', 'EXCLUDED', 'NEW', 'NEW_CITATIONS', 'PWC_TASK', 'A.1', 'COMPUTER SCIENCE - COMPUTATION AND LANGUAGE', 'COMPUTER SCIENCE - ARTIFICIAL INTELLIGENCE', 'HERE', 'DONTHAVECODE', 'NOTBENCHMARKED', 'ACM', 'HAVECODE', 'HUMAN EVOLUTION', 'INFORMATION OVERLOAD', 'INFORMATION TECHNOLOGY EVOLUTION', 'KNOWLEDGE ACQUISITION', 'PROPAGATION SCHOLARLY ERRORS', 'SEMANTIC WEB', 'TECHNOLOGICAL FORECASTING', 'WORLD WIDE WEB', 'MANUALMODELS', 'COMPUTER SCIENCE - INFORMATION RETRIEVAL', 'SAT_TYPOLOGY', 'SAT_NBTYPES_ENTITY', 'SAT_SOURCE']
